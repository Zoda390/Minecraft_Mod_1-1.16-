package com.turtywurty.tutorialmod.client.screen;
...
public class DisplayCaseScreen extends ContainerScreen<DisplayCaseContainer> {
    ...
    private static final ResourceLocation DISPLAY_CASE_GUI = new ResourceLocation(TutorialMod.MOD_ID, "textures/gui/display_case.png");
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        matrixStack.push();
        matrixStack.translate((this.width - this.xSize) / 2, (this.height - this.ySize) / 2, 0);
